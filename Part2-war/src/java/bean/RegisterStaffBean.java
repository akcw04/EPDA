...
public class RegisterStaffBean implements Serializable {
    ...
    public void register() {
        ...
        if (processPassword(password).equals("0")) {
            ...
            passwordError1 = "";
            passwordError2 = "";
            passwordError3 = "Please retype your password.";
        }
        ...
        if (icError.equals("")) {
            ...
            if (managerFound != null || counterStaffFound != null || technicianFound != null) {
                icExists = true;
            } else {
                icExists = false;
            }
        ...
        if (roleError.equals("") && nameError.equals("") && passwordError1.equals("") && passwordError2.equals("") && passwordError3.equals("Please retype your password.") 
        ...
        if (valuesCorrect == true) {
            ...
            if (role.equals("manager")) {
                ManagerFacade.create(new Manager(name, password, gender, phone, ic, email, address, createdBy));
                roleName = "Manager";
            } else if (role.equals("counter_staff")) {
                CounterStaffFacade.create(new CounterStaff(name, password, gender, phone, ic, email, address, createdBy));
                roleName = "Counter Staff";
            } else if (role.equals("technician")) {
                TechnicianFacade.create(new Technician(name, password, gender, phone, ic, email, address, createdBy));
                roleName = "Technician";
            }
            successMessage = name + " (" + roleName + ") has been successfully registered!";
